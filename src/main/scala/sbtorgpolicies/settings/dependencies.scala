...
trait dependencies {
  ...
  private[this] val libs: Map[String, Dep] = Map(
    ...
    "catbird-util"                -> Dep("io.catbird", "catbird-util", v("catbird")),
    ...
    "doobie-core"                 -> Dep("org.tpolecat", "doobie-core", v("doobie")),
    "doobie-core-cats"            -> Dep("org.tpolecat", "doobie-core-cats", v("doobie")),
    "doobie-hikari"               -> Dep("org.tpolecat", "doobie-hikari", v("doobie")),
    "doobie-hikari-cats"          -> Dep("org.tpolecat", "doobie-hikari-cats", v("doobie")),
    "doobie-h2"                   -> Dep("org.tpolecat", "doobie-h2", v("doobie")),
    "doobie-h2-cats"              -> Dep("org.tpolecat", "doobie-h2-cats", v("doobie")),
    "doobie-postgres"             -> Dep("org.tpolecat", "doobie-postgres", v("doobie")),
    "doobie-postgres-cats"        -> Dep("org.tpolecat", "doobie-postgres-cats", v("doobie")),
    "doobie-scalatest"            -> Dep("org.tpolecat", "doobie-scalatest", v("doobie")),
    "doobie-scalatest-cats"       -> Dep("org.tpolecat", "doobie-scalatest-cats", v("doobie")),
    "doobie-specs2"               -> Dep("org.tpolecat", "doobie-specs2", v("doobie")),
    "doobie-specs2-cats"          -> Dep("org.tpolecat", "doobie-specs2-cats", v("doobie")),
    ...
    "finch-core"                  -> Dep("com.github.finagle", "finch-core", v("finch")),
    ...
    "mockito"                     -> Dep("org.mockito", "mockito-all", v("mockito")),
    "mockito-core"                -> Dep("org.mockito", "mockito-core", v("mockito")),
    ...
    "play-test"                   -> Dep("com.typesafe.play", "play-test", v("play")),

...
object libraries {
  ...
  val scalaLibs: Map[String, Artifact] = Map(
    ...
    "freestyle-async"        -> (("com.47deg", "freestyle-async", v("freestyle"))),
    "freestyle-async-fs2"    -> (("com.47deg", "freestyle-async-fs2", v("freestyle"))),
    "freestyle-async-monix"  -> (("com.47deg", "freestyle-async-monix", v("freestyle"))),
    "freestyle-cache"        -> (("com.47deg", "freestyle-cache", v("freestyle"))),
    "freestyle-cache-redis"  -> (("com.47deg", "freestyle-cache-redis", v("freestyle"))),
    "freestyle-config"       -> (("com.47deg", "freestyle-config", v("freestyle"))),
    "freestyle-doobie"       -> (("com.47deg", "freestyle-doobie", v("freestyle"))),
    "freestyle-effects"      -> (("com.47deg", "freestyle-effects", v("freestyle"))),
    "freestyle-fetch"        -> (("com.47deg", "freestyle-fetch", v("freestyle"))),
    "freestyle-fs2"          -> (("com.47deg", "freestyle-fs2", v("freestyle"))),
    "freestyle-http-akka"    -> (("com.47deg", "freestyle-http-akka", v("freestyle"))),
    "freestyle-http-finch"   -> (("com.47deg", "freestyle-http-finch", v("freestyle"))),
    "freestyle-http-http4s"  -> (("com.47deg", "freestyle-http-http4s", v("freestyle"))),
    "freestyle-http-play"    -> (("com.47deg", "freestyle-http-play", v("freestyle"))),
    "freestyle-logging"      -> (("com.47deg", "freestyle-logging", v("freestyle"))),
    "freestyle-monix"        -> (("com.47deg", "freestyle-monix", v("freestyle"))),
    "freestyle-slick"        -> (("com.47deg", "freestyle-slick", v("freestyle"))),
    "freestyle-tagless"      -> (("com.47deg", "freestyle-tagless", v("freestyle"))),
    "freestyle-twitter-util" -> (("com.47deg", "freestyle-twitter-util", v("freestyle"))),

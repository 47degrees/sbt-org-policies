...
object libraries {
  ...
  val scalaLibs: Map[String, Artifact] = Map(
    ...
    "alleycats"             -> ("org.typelevel", "alleycats", v("alleycats")),
    ...
    "catalysts"             -> ("org.typelevel", "catalysts", v("catalysts")),
    ...
    "cats-state"            -> ("org.typelevel", "cats-state", v("cats")),
    ...
    "mockito"               -> ("org.mockito", "mockito-all", v("mockito")),
  ...
  val libs: Map[String, Artifact] = javaLibs ++ scalaLibs
}

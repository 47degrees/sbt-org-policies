...
object libraries {
  ...
  val scalaLibs: Map[String, Artifact] = Map(
    ...
    "frees-async-monix"      -> (("io.frees", "frees-async-monix", v("freestyle"))),
    ...
    "frees-fs2"              -> (("io.frees", "frees-fs2", v("freestyle"))),
    "frees-http-akka"        -> (("io.frees", "frees-http-akka", v("freestyle"))),
    "frees-http-finch"       -> (("io.frees", "frees-http-finch", v("freestyle"))),
    "frees-http-http4s"      -> (("io.frees", "frees-http-http4s", v("freestyle"))),
